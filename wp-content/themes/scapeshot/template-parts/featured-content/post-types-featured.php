...
$scapeshot_number = get_theme_mod( 'scapeshot_featured_content_number', 3 );
...
$scapeshot_args['post_type'] = 'featured-content';

for ( $scapeshot_i = 1; $scapeshot_i <= $scapeshot_number; $scapeshot_i++ ) {
	$scapeshot_post_id = '';

	$scapeshot_post_id =  get_theme_mod( 'scapeshot_featured_content_cpt_' . $scapeshot_i );
